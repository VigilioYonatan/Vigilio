...
function h(i, o, e) {
    ...
    if (o)
        for (var t = 0, s = Object.entries(o); t < s.length; t++) {
            var l = s[t],
                c = l[0],
                a = l[1];
            if ("object" == typeof a)
...
function bottomBackground(i, o) {
    var e = i / 10,
        ...
        s = 0;
    function l() {
        s < e && ((t += n), (o.style.width = t + "%"), s++, setTimeout(l, 10));
    }
    setTimeout(l, 10);
}
...
function sweetModal(i) {
    var o = i.icon,
        e = void 0 === o ? "info" : o,
        n = i.text,
        t = void 0 === n ? "\xa1No podr\xe1s revertir esto!" : n,
        s = i.html,
        l = i.title,
        c = void 0 === l ? "\xbfEstas seguro?" : l,
        a = i.showCancelButton,
        r = void 0 !== a && a,
        d = i.cancelButtonText,
        $ = void 0 === d ? "Cancelar" : d,
        v = i.showCloseButton,
        m = void 0 !== v && v,
        _ = i.showConfirmButton,
        g = void 0 === _ || _,
        f = i.confirmButtonText,
        u = void 0 === f ? "OK!" : f,
        p = i.cancelButtonAriaLabel,
        w = void 0 === p ? "cancel" : p,
        y = i.confirmButtonAriaLabel,
        b = void 0 === y ? "ok" : y,
        x = i.position,
        C = void 0 === x ? "center" : x,
        L = i.customIcon,
    ...
    return new Promise(function (i) {
        var o,
            ...
            l = n.querySelector(".vigilio-modal .modal");
        function a() {
            l.classList.add("vigilio-modal-hidde"),
                setTimeout(function () {
                    document.body.classList.remove("overflow-hidden"),
                        null == l || l.classList.remove("vigilio-modal-hidde"),
        ...
        if (
            ...
            var d = n.querySelector(".vigilio-loader"),
                v = 1e3 * B;
            bottomBackground(v, d),
                setTimeout(function () {
                    a();
                }, v + 150);
        }
...
function sweetAlert(i) {
    ...
    return new Promise(function (i) {
            ...
            a = h(
                ...
                n
                    ...
                    : [
                          ...
                          c
                              ? h("div", null, c).firstElementChild
                              : ((o = e),
                                {
                                    danger: h(
                                        "div",
                          ...
                          h("span", { className: "vigilio-title" }, t),
                          h("div", {
                              className: "vigilio-loader",
                              style: {
                                  cssText: "--bg-loader:".concat(colorIcon(e)),
                              },
                          }),
                      ]
            );
        function d() {
            i({ isConfirmed: !1 }),
                a.classList.add("vigilio-alert-hidde"),
                setTimeout(function () {
                    a.remove();
                }, 300);
        }
        document.body.querySelector(".vigilio-alert")
            ? null === (s = document.body.querySelector(".vigilio-alert")) ||
              void 0 === s ||
              s.prepend(a)
            ...
            setTimeout(function () {
                a.classList.add("vigilio-alert-show");
            }, 1);
        var v = a.querySelector(".vigilio-loader"),
            g = 1e3 * r;
        bottomBackground(g, v),
            setTimeout(function () {
                d();
            }, g + 150);
    });
