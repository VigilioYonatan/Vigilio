    ...
    if (n)
        for (var l = 0, s = Object.entries(n); l < s.length; l++) {
            var c = s[l],
                ...
                a = c[1];
            if ("object" == typeof a)
                for (var r = 0, v = Object.entries(a); r < v.length; r++) {
                    var d = v[r],
                        u = d[0],
                        g = d[1];
                    e[t][u] = g;
...
function sweet(i) {
    var n = i.icon,
        o = void 0 === n ? "info" : n,
        e = i.text,
        l = void 0 === e ? "\xa1No podr\xe1s revertir esto!" : e,
        s = i.html,
        c = i.title,
        t = void 0 === c ? "\xbfEstas seguro?" : c,
        a = i.showCancelButton,
        r = void 0 !== a && a,
        v = i.cancelButtonText,
        d = void 0 === v ? "Cancelar" : v,
        u = i.showCloseButton,
        g = void 0 !== u && u,
        f = i.showConfirmButton,
        m = void 0 === f || f,
        p = i.confirmButtonText,
        y = void 0 === p ? "OK!" : p,
        $ = i.cancelButtonAriaLabel,
        b = void 0 === $ ? "cancel" : $,
        N = i.confirmButtonAriaLabel,
        x = void 0 === N ? "ok" : N,
        k = i.position,
        C = void 0 === k ? "center" : k,
        w = i.customIcon,
    ...
    return new Promise(function (i) {
        var n,
            ...
            c = e.querySelector(".vigilio-modal .modal");
        function a() {
            c.classList.add("vigilio-modal-hidde"),
                setTimeout(function () {
                    null == c || c.classList.remove("vigilio-modal-hidde"),
